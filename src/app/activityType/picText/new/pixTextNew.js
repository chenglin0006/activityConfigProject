...
import PicturesWall from '../../../components/uploadImage/index';
...
export default class PicTextNew extends Component {
    constructor(props) {
        super(props);
            ...
            if(option.type =='button'){
                return <span key={i} className={option.isHide?'hide':''}><Button key={i} size={option.size} type={option.buttonType} style={option.style} onClick={
                    ()=>{
                        ...
                        this.props[option.clickHandleName](this.props.form.getFieldsValue(),option.id)
                    }
